import authorImage from "../../assets/profilePicture.avif";
import "./About.css";
      ...
      <div className="about__content">
        ...
        <div className="about__author-text">
          ...
          <p className="about__paragraph">
            Hi, I&apos;m Peyton! I&apos;m a passionate web developer with a love
            for creating engaging and user-friendly applications. This news
            explorer website is my final project for the TripleTen coding
            bootcamp. It showcases my skills in React, JavaScript, working with
